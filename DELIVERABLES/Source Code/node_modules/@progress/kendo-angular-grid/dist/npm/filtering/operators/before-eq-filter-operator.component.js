 ...
 * For basic usage examples, refer to the sections on
 * [setting the default filter operators]({% slug builtinfiltertemplate_grid %}#toc-setting-the-default-filter-operator)
 * and [setting the order of the filter operators]({% slug builtinfiltertemplate_grid %}#toc-setting-the-order-of-the-filter-operators).
 */
                    ...
                    providers: [
                        {
                            ...
                            useExisting: core_1.forwardRef(function () { return BeforeEqFilterOperatorComponent; }) // tslint:disable-line:no-forward-ref
                        }
                    ],
