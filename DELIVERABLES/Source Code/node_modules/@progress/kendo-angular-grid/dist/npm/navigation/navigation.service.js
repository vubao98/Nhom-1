...
var NavigationService = /** @class */ (function () {
    ...
    NavigationService.prototype.init = function (meta) {
        ...
        this.cursor.changes
            ...
            _this.activeRowIndex = args.rowIndex;
        ...
        this.editService.changes.pipe(takeWhile_1.takeWhile(isAlive), filter_1.filter(function (e) { return e.action !== 'edit' && _this.mode === 2 /* Content */; }), filter_1.filter(function (e) { return e.action === 'cellClose' && !e.prevented; }), switchMap_1.switchMap(onStable, function (args) { return args; }))
        ...
        this.domEvents.keydown.pipe(takeWhile_1.takeWhile(isAlive), filter_1.filter(function (args) { return args.keyCode === 9 /* tab */ && _this.mode === 2 /* Content */; }), switchMapTo_1.switchMapTo(this.domEvents.focusOut.pipe(takeUntil_1.takeUntil(
        // Timeout if focusOut doesn't fire very soon
        interval_1.interval(0).pipe(take_1.take(1))))))
            .subscribe(function () {
            // Tabbed out of the last focusable content element
            // reset to cursor mode and recapture focus.
            if (_this.cursor.cell.focusGroup.isNavigable()) {
