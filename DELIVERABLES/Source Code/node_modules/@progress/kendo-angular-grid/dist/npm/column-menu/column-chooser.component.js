...
/**
 * Represents the column chooser item for the Grid columns.
 *
 * To allow the user to show and hide the Grid columns,
...
var ColumnChooserComponent = /** @class */ (function () {
    function ColumnChooserComponent(localization, columnInfoService, popupService, ngZone, renderer, changeDetector) {
        ...
        /**
         * Specifies if the changes in the column visibility will be immediately applied.
         */
        this.autoSync = false;
        /**
     ...
     * @hidden
     */
    ColumnChooserComponent.prototype.onApply = function () {
        this.close();
     ...
     * @hidden
     */
    ColumnChooserComponent.prototype.onChange = function () {
        this.changeDetector.markForCheck();
    };
