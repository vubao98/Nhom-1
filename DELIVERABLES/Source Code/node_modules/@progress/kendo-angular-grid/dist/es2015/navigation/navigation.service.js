...
export class NavigationService {
    ...
    init(meta) {
        ...
        this.editService.changes.pipe(takeWhile(isAlive), filter(e => e.action !== 'edit' && this.mode === 2 /* Content */), filter((e) => e.action === 'cellClose' && !e.prevented), switchMap(onStable, args => args))
        ...
        this.domEvents.keydown.pipe(takeWhile(isAlive), filter(args => args.keyCode === 9 /* tab */ && this.mode === 2 /* Content */), switchMapTo(this.domEvents.focusOut.pipe(takeUntil(
