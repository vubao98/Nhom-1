...
var NavigationService = /** @class */ (function () {
    ...
    NavigationService.prototype.init = function (meta) {
        ...
        this.editService.changes.pipe(takeWhile(isAlive), filter(function (e) { return e.action !== 'edit' && _this.mode === 2 /* Content */; }), filter(function (e) { return e.action === 'cellClose' && !e.prevented; }), switchMap(onStable, function (args) { return args; }))
        ...
        this.domEvents.keydown.pipe(takeWhile(isAlive), filter(function (args) { return args.keyCode === 9 /* tab */ && _this.mode === 2 /* Content */; }), switchMapTo(this.domEvents.focusOut.pipe(takeUntil(
