 ...
 *
 * > You can use the directive only with a DateInput component.
 */
export declare class DateRangeStartInputDirective extends DateRangeInput implements OnInit, OnDestroy {
     ...
     * (see the [basic usage example]({% slug autocorrect_daterange %}#toc-configuring-input-directives)).
     *
     ...
     * When enabled, the calendar navigates to the value of the focused input.
     * Otherwise, the calendar displays the last picked date.
     *
