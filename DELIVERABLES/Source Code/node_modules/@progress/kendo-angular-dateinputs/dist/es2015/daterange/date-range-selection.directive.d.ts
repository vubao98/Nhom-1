...
export declare class DateRangeSelectionDirective implements OnInit {
    ...
    /**
     * Specifies the auto-correction behavior.
     * If the start date is greater than the end date,
     * the directive fixes the date range to a single date
     * either on input change or on blur
     * (see the [basic usage example]({% slug autocorrect_daterange %}#toc-configuring-the-calendar-selection-directive)).
     *
     * By default, the auto-correction is triggered on change.
     * To disable this behavior, set the property to `none`.
     */
    ...
    /**
     * Gets or sets the active end of the selection range.
     * This option determines which range end will be updated on user interaction.
     * When a new active end is set, the connected DateRangeService notifies all related parties.
     */
    /**
     * Specifies which end of the selection range will be marked as active.
     * The active end gets modified upon user interaction.
     * When a new active end is set, the wired DateRangeService notifies all related components.
     * For example, the start and end DateInput components.
     *
     * > If the selection range is undefined, the value is ignored.
     */
    activeRangeEnd: SelectionRangeEnd;
    /**
     * Fires when the active range end is changed.
    ...
    /**
     * Fires when the selection range is changed.
     * For more information, refer to the section on [events]({% slug overview_multiviewcalendar %}#toc-events).
     */
